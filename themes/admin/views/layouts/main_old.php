...
<div id="header"> 
	...
	<?php $this->widget('application.extensions.emenu.EMenu',array(
			...
			'items'=>array(
			    ...
			    array('label'=>'Summary Pegawai', 'url'=>array('/pegawai/rekappegawai')),
			    array('label'=>'Daftar pengguna', 'url'=>array('/member'),
				  'visible'=>(!Yii::app()->user->isGuest && Yii::app()->user->getState('level') == 'admin')),
