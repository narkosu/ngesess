<div class="speedbar">
    <div class="speedbar-content">
        ...
        <a href="<?php echo Yii::app()->createUrl('masters/anggota')?>" class="button icon home">Anggota</a>
				<a href="<?php echo Yii::app()->createUrl($this->module->id.'/anggota/create')?>" class="button icon add">Tambah</a>
